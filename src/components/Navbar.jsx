...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="navbar">
        ...
        {click ? <AiOutlineClose className='close-menu'  onClick={closeMobileMenu}/> : <GiHamburgerMenu className='open-menu' onClick={showElement}/>}
